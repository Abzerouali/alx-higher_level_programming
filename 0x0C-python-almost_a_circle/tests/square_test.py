...
Unittest classes:
    TestSquareInstantiation - Defines tests for the instantiation of the Square class.
    TestSquareSize - Defines tests for the size initialization of the Square class.
    TestSquareX - Defines tests for the initialization of the Square x attribute.
    TestSquareY - Defines tests for the initialization of the Square y attribute.
    TestSquareOrderOfInitialization - Defines tests for the order of Square attribute initialization.
    TestSquareArea - Defines tests for the area method of the Square class.
    TestSquareStdout - Defines tests for the __str__ and display methods of the Square class.
    TestSquareUpdateArgs - Defines tests for the update args method of the Square class.
    TestSquareUpdateKwargs - Defines tests for the update kwargs method of the Square class.
    TestSquareToDictionary - Defines tests for the to_dictionary method of the Square class.
"""
import io
import sys
import unittest
...
class TestSquare_instantiation(unittest.TestCase):
    """Defines tests for the instantiation of the Square class."""
